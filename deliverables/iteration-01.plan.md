...
We believe that distributing some of the harder tasks to members who are not as experienced in the particular field compared to others can be beneficial in the long term by enhancing their skill set and facilitating harder implementation in the future. When the time comes where we are working towards a goal of parallel development with team members, we would be avoiding chain development circumstances later in the development cycle. 
